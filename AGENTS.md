...
**Note**: This file (`AGENTS.md`) is the canonical source for all agents except GitHub Copilot. The file `.github/copilot-instructions.md` is a specifically for GitHub Copilot integration.
...
The following files are included as part of these instructions by reference:

- Language and file-type specific instructions: `.github/instructions/*.instructions.md`
- Aurora canonical definitions: `.github/instructions/details/*.md`

These files provide additional context and constraints that supplement the rules in this document.
