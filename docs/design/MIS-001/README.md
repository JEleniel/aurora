...
- Aurora model root: [//home/jeleniel/repos/aurora/docs/design/aurora](../aurora)
- Mission entrypoint: [MIS-001.json](../aurora/MIS-001.json)

## Views

Standard views are rendered under `views`. Links to generated views are below.

- [Requirements View](views/requirements-view.md)
- [System Composition](views/system-composition.md)
- [Process Flow](views/process-flow.md)
- [State Machine](views/state-machine.md)
...
- [Export Compact Model Snapshot](cards/Requirement/REQ-016.md)
...
- [Compact Model Packaging](cards/Capability/CAP-007.md)
...
- [Compact Model Export Command](cards/Feature/FEA-007.md)
