...
Welcome to the AURORA project documentation. This site is published with GitHub Pages and uses the Midnight theme.

See the `docs/` directory for content and the `docs/_data/navigation.yml` file for site navigation.
