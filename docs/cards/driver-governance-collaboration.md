# Support Governance and Collaboration Workflows

---

- **ID**: `driver:governance-collaboration`
- **Type**: `driver`
- **Version**: `1.0.0`
- **Status**: `proposed`
...
Support human+agent workflows for proposing, reviewing, approving, and evolving cards; preserve audit and provenance for auditability.
...
```json
{
  "id": "driver:governance-collaboration",
  "type": "driver",
  "name": "Support Governance and Collaboration Workflows",
  "description": "Support human+agent workflows for proposing, reviewing, approving, and evolving cards; preserve audit and provenance for auditability.",
  "version": "1.0.0",
  "status": "proposed",
  "attributes": {
    "workflow": [
