# Treat Tests as First-Class Artifacts

---

- **ID**: `driver:testability`
- **Type**: `driver`
- **Version**: `1.0.0`
- **Status**: `proposed`
...
Treat tests and acceptance criteria as first-class cards and require links from requirements to tests to support automated verification.
...
```json
{
  "id": "driver:testability",
  "type": "driver",
  "name": "Treat Tests as First-Class Artifacts",
  "description": "Treat tests and acceptance criteria as first-class cards and require links from requirements to tests to support automated verification.",
  "version": "1.0.0",
  "status": "proposed",
  "attributes": {
