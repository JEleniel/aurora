# Keep Schema Minimal and Composable

---

- **ID**: `driver:simplicity`
- **Type**: `driver`
- **Version**: `1.0.0`
- **Status**: `proposed`
...
Keep the core schema minimal and composable; enforce one-element=one-card and avoid unnecessary complexity.
...
```json
{
  "id": "driver:simplicity",
  "type": "driver",
  "name": "Keep Schema Minimal and Composable",
  "description": "Keep the core schema minimal and composable; enforce one-element=one-card and avoid unnecessary complexity.",
  "version": "1.0.0",
  "status": "proposed",
  "attributes": {
    "schema_principle": "minimal"
  },
  "relations": [
    "driver:root"
  ],
