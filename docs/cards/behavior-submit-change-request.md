...
- **ID**: `behavior:submit-change-request`
- **Type**: `behavior`
- **Version**: `1.0.0`
- **Status**: `proposed`
- **Priority**: `medium`
...
Stakeholders submit change requests for review, approval, and scheduling.
...
```json
{
  ...
  "description": "Stakeholders submit change requests for review, approval, and scheduling.",
  "version": "1.0.0",
  "status": "proposed",
  "priority": "medium",
  "owner": "governance-team",
