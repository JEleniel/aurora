...
Constrain canonical formats to JSON/; reject YAML and other whitespace-delimited formats for AURORA artifacts.
...
```json
{
  "id": "driver:formats",
  "type": "driver",
  "name": "Enforce JSON-First Formats",
  "description": "Constrain canonical formats to JSON/; reject YAML and other whitespace-delimited formats for AURORA artifacts.",
  "version": "1.0.0",
  "status": "proposed",
  "attributes": {
