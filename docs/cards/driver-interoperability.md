# Enable Interoperability via Structured Contexts

---

- **ID**: `driver:interoperability`
- **Type**: `driver`
- **Version**: `1.0.0`
- **Status**: `proposed`
...
Adopt namespace-friendly IDs and structured contexts to ease integration with external toolchains and ontologies.
...
```json
{
  "id": "driver:interoperability",
  "type": "driver",
  "name": "Enable Interoperability via Structured Contexts",
  "description": "Adopt namespace-friendly IDs and structured contexts to ease integration with external toolchains and ontologies.",
  "version": "1.0.0",
  "status": "proposed",
  "attributes": {
    "use_context": true,
