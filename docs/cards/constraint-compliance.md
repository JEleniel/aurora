...
Persisted data must reside within approved geographic regions to satisfy legal and regulatory requirements.

## Provenance

- **source**: `compliance guidance`
- **owner**: `security-team`
- **version**: `1.0`
...
```json
{
  ...
  "description": "Persisted data must reside within approved geographic regions to satisfy legal and regulatory requirements.",
