...
Persisted architecture artifacts and logs must remain under 100GB to control costs and retention.

## Provenance

- **source**: `ops constraints`
- **owner**: `platform-team`
- **version**: `1.0`
...
```json
{
  ...
  "description": "Persisted architecture artifacts and logs must remain under 100GB to control costs and retention.",
