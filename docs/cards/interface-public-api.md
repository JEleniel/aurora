...
HTTP-based public API endpoints for external integrations and partner systems.
...
```json
{
  "id": "interface:public-api",
  "type": "interface",
  "name": "Expose Public API",
  "description": "HTTP-based public API endpoints for external integrations and partner systems.",
  "version": "1.0.0",
  "status": "proposed",
  "priority": "high",
  "owner": "api-team",
