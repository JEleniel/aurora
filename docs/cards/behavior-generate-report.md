...
Generate operational or business reports from system data on demand or by schedule.
...
**Relations**: [actor:business-stakeholder](../cards/actor-business-stakeholder.md)
...
```json
{
  ...
  "description": "Generate operational or business reports from system data on demand or by schedule.",
  "version": "1.0.0",
  "status": "proposed",
  "priority": "medium",
  "owner": "analytics-team",
