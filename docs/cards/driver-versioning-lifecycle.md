# Apply Semantic Versioning and Lifecycle Controls

---

- **ID**: `driver:versioning-lifecycle`
- **Type**: `driver`
- **Version**: `1.0.0`
- **Status**: `proposed`
...
Require semantic versioning, status enums, and audit records on cards to track lifecycle and releases.
...
```json
{
  "id": "driver:versioning-lifecycle",
  "type": "driver",
  "name": "Apply Semantic Versioning and Lifecycle Controls",
  "description": "Require semantic versioning, status enums, and audit records on cards to track lifecycle and releases.",
  "version": "1.0.0",
  "status": "proposed",
  "attributes": {
